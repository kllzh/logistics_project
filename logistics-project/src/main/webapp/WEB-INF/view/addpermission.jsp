...
<article class="page-container">
 <form class="form form-horizontal" id="userform" action=${empty permission? 'permission/insert.do':'permission/update.do'}>
	<!-- hidden:隐藏域；不显示 -->
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text" autocomplete="off" value="${permission.expression}"  placeholder="" id="expression" name="expression">
		</div>
	</div>
