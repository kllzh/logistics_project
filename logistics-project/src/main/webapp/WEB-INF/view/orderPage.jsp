		...
		*/
		...
		columns: [ //表格显示数据对应的表头设置，
			...
			*/
			...
			{field: 'orderId',title: '区间范围'},
			{field: 'shippingAddress',title: '发货地址'},
			{field: 'shippingName',title: '发货人'},
			{field: 'shippingPhone',title: '发货人手机'},
			{field: 'takeName',title: '收货人姓名'},
			{field: 'takeAddress',title: '收货人地址'},
			{field: 'takePhone',title: '收货人手机'},
...
function admin_add(){	
	layer_show("添加用户","order/addorder.do","800","500");
}
      ...
      //批量删除
       ...
       layer.confirm('确认要删除吗？',{icon:3},function(index){
            ...
            var str01=[];     
             ...
             console.log(str)
             console.log(str01)
            $.post("order/deleteall.do",{"orderId":str01},function(data){
...
function admin_edit(id){
	layer_show("修改管理员信息","order/editorder.do?orderId="+id,800,500);
}
/*管理员-停用*/
