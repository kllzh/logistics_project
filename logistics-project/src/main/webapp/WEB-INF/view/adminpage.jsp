...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20" id="toolbar"> <span class="l">
	  <shiro:hasPermission name="admin:delete"> 
	   <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>	
	  </shiro:hasPermission> 
	  
	  <shiro:hasPermission name="admin:insert"> 
	    <a href="javascript:;" onclick="admin_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">
	 </shiro:hasPermission> 
	 </span></div>
...
function operationFormatter(value,row,index){
	...
	html +='<a title="编辑" href="javascript:;" onclick="admin_edit('+value+')" style="text-decoration:none"><i class="Hui-iconfont"></i></a>';	
...
function admin_add(){
	...
	layer_show("添加用户","admin/adduser.do","800","500");
}
      ...
      //批量删除
       ...
       layer.confirm('确认要删除吗？',{icon:3},function(index){
            ...
            var str01=[];     
             ...
             console.log(str)
             console.log(str01)
            $.post("admin/deleteall.do",{"userId":str01},function(data){
...
function admin_edit(id){
	layer_show("修改管理员信息","admin/edit.do?userid="+id,800,500);
}
/*管理员-停用*/
