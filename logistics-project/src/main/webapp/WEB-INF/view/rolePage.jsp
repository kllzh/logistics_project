...
function admin_add(){
	...
	layer_show("添加角色","role/addrole.do",800,500);
}
      ...
      //批量删除
       ...
       layer.confirm('确认要删除吗？',{icon:3},function(index){
            ...
            var str01=[];     
             ...
             console.log(str)
             console.log(str01)
            $.post("role/deleteall.do",{"userId":str01},function(data){ 
...
function admin_edit(id){
	layer_show("修改管理员信息","role/editrole.do?roleId="+id,800,500);
}
/*管理员-停用*/
