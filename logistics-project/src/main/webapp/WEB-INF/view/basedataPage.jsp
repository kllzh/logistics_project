		...
		*/
		...
		columns: [ //表格显示数据对应的表头设置，
			...
			*/
			...
			{field: 'baseName',title: '数据名称'}, 
			{field: 'baseDesc',title: '基础数据描述'},
			{field: 'parentName',title: '父类型数据'},
...
function admin_add(){
	...
	layer_show("添加用户","basedata/addbasedata.do","800","500");
}
...
function admin_del(id){
	...
	layer.confirm('确认要删除吗？',{icon:3},function(index){
		$.ajax({
			...
			url: "basedata/delete.do?baseId="+id+"",
      ...
      //批量删除
       ...
       layer.confirm('确认要删除吗？',{icon:3},function(index){
            ...
            var str01=[];     
             ...
             console.log(str)
             console.log(str01)
            $.post("basedata/deleteall.do",{"baseId":str01},function(data){
...
function admin_edit(id){
	layer_show("修改管理员信息","basedata/editbasedata.do?baseId="+id,800,500);
}
/*管理员-停用*/
